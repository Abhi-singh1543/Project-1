...
/path/to/Project-1/jenkins_server/tf-aws-ec2
...
pipeline{
    ...
    stages {
        stage('Checkout SCM') {
            steps {
                script {
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[url: 'https://github.com/Abhi-singh1543/Project-1.git']])
                }
            }
        }
...
This project is maintained by **[Abhishek](https://github.com/Abhi-singh1543)** 💡.  
I’d love to hear your feedback! Feel free to share your thoughts.  

📧 **Connect with me:**

- **GitHub**: [@Abhi-singh1543](https://github.com/Abhi-singh1543)
